        ...
        <div className="margin-top-32">
            ...
            <ul>
                ...
                <Box>
                    ...
                    >
                        <Tab value="1" label="Pipocas 'simples'" />
                        <Tab value="2" label="Pipocas Doces" />
                        <Tab value="3" label="Pipocas Salgadas" />
                        <Tab value="4" label="Pipocas Coloridas" />
                    </Tabs>
                    <Box hidden={value !== "1"}>
                        <ul>
                            <li>
